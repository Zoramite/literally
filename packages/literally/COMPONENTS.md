...
| `themeSurface`            | Sets surface theme colors.                                                                |
...
| `themePrimaryContainer`    | Apply primary-container theme color.                       |
| `themeSecondary`           | Apply secondary theme color.                               |
| `themeSecondaryContainer`  | Apply secondary-container theme color.                     |
| `themeTertiary`            | Apply tertiary theme color.                                |
| `themeTertiaryContainer`   | Apply tertiary-container theme color.                      |
| `themeError`               | Apply error theme color.                                   |
| `themeErrorContainer`      | Apply error-container theme color.                         |
| `themeSurface`             | Apply surface theme color.                                 |
| `themeSurfaceVariant`      | Apply surface-variant theme color.                         |
| `themeSurfaceContainer`    | Apply surface-container theme color.                       |
| `themeSurfaceContainerLow` | Apply surface-container-low theme color.                   |
...
| `themeSurface`            | Apply surface theme colors.                        |
| `themeSurfaceVariant`     | Apply surface-variant theme colors.                |
| `themeSurfaceContainer`   | Apply surface-container theme colors.              |
...
| `themeSurfaceVariant`      | Sets surface-variant theme colors.       |
| `themeSurfaceContainer`    | Sets surface-container theme colors.     |
| `themeSurfaceContainerLow` | Sets surface-container-low theme colors. |
| `themePrimary`             | Sets primary theme colors.               |
| `themePrimaryContainer`    | Sets primary-container theme colors.     |
| `themeSecondary`           | Sets secondary theme colors.             |
| `themeSecondaryContainer`  | Sets secondary-container theme colors.   |
...
| Name        | Description        |
| ----------- | ------------------ |
| _(default)_ | Label for the link |
